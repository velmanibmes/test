...
class Notice{
    ...
    public function  generate_html() {
        ...
        >
            <?php wp_nonce_field( 'eventin-banner-notice', 'eventin-banner-notice-noce' ); ?>
    ...
    public static function dismiss_ajax_call() {
		...
		$nonce          = ( isset( $post_arr['nonce'] ) )    ? $post_arr['nonce'] : '  ';
        ...
        // Verify nonce.
        if ( ! wp_verify_nonce( $nonce, 'eventin-banner-notice' ) ) {
            return;
        }
			...
			<script>
                jQuery(document).ready(function ($) {
                    $( '.wpmet-notice.is-dismissible' ).on( 'click', '.notice-dismiss', function() {
                        ...
                        var nonce = $(_this).find('input[name="eventin-banner-notice-noce"]').val();
                        _this.hide();
