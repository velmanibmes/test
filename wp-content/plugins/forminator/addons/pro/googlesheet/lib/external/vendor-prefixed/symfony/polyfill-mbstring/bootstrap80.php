 ...
 */
use ForminatorGoogleAddon\Symfony\Polyfill\Mbstring as p;
...
if (!\function_exists('ForminatorGoogleAddon\\mb_ltrim')) {
...
if (!\function_exists('ForminatorGoogleAddon\\mb_rtrim')) {
