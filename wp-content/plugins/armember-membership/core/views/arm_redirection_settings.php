						...
						">
							...
							<td>
								...
								<div class="arm_default_redirection_txt">
									...
									<span class="arm_info_text"><?php echo sprintf( esc_html__('Use %s to add current user\'s usrename in url.', 'armember-membership'),"<strong>{ARMCURRENTUSERNAME}</strong>"); ?></span><br/><?php //phpcs:ignore ?>
									<span class="arm_info_text"><?php echo sprintf(esc_html__('Use %s to add current user\'s id in url.', 'armember-membership'),"<strong>{ARMCURRENTUSERID}</strong>"); ?></span><?php //phpcs:ignore ?>
								</div>
							</td>
						</tr>
								...
								<div class="arm_signup_conditional_redirection_main_div">
									...
									<?php if($ARMemberLite->is_arm_pro_active){?>
										<div class="arm_signup_conditional_redirection_link">
											...
											<a id="arm_signup_conditional_redirection_add_new_condition" class="arm_signup_conditional_redirection_add_new_condition" href="javascript:void(0)" data-field_index="2">+ <?php esc_html_e('Add New Condition', 'armember-membership'); ?></a>
										</div>
                                    	<br/><br/>
									<?php }?>
									<div class="arm_default_redirection_lbl">
							...
							<td class="arm-form-table-content">                     
								...
								<?php if($ARMemberLite->is_arm_pro_active){?>
									<label class="arm_min_width_100">
                                       ...
                                       <span><?php esc_html_e('Conditional Redirect','armember-membership');?></span>
                                </label>
								<?php }?>
							</td>
						</tr>
					 ...
					 <table class="form-table">
						<tr>
							...
							<td class="arm-form-table-content">                     
								...
								<?php if($ARMemberLite->is_arm_pro_active){?>
									<label class="arm_min_width_100">
                                        <input type="radio" name="arm_redirection_settings[setup_change][type]" value="conditional_redirect" class="arm_redirection_settings_setup_change_radio arm_iradio" <?php checked($arm_redirection_setup_change_type, 'conditional_redirect');?> >
                                       <span><?php esc_html_e('Conditional Redirect','armember-membership');?></span>
                                </label>
								<?php }?>
						...
						<tr  id="arm_redirection_settings_setup_change_conditional_redirect" class="arm_redirection_settings_setup_change 
						<?php
						...
						">
							...
							<td>  
								<div class="arm_setup_change_conditional_redirection_main_div">
									<ul class="arm_setup_change_conditional_redirection_ul arm_margin_bottom_20" >
									<?php
									if ( empty( $arm_redirection_setup_change_conditional_redirect ) ) {
										...
										$url = ARMLITE_HOME_URL;
										?>
									<li id="arm_setup_change_conditional_redirection_box0" class="arm_setup_change_conditional_redirection_box_div">
								  
										<a class="arm_remove_setup_change_redirection_condition" href="javascript:void(0)" data-index="0"><img src='<?php echo esc_attr(MEMBERSHIPLITE_IMAGES_URL); ?>/arm_close_icon.png' onmouseover="this.src='<?php echo esc_attr(MEMBERSHIPLITE_IMAGES_URL); ?>/arm_close_icon_hover.png';" onmouseout="this.src='<?php echo esc_attr(MEMBERSHIPLITE_IMAGES_URL); ?>/arm_close_icon.png';" /></a> <?php //phpcs:ignore ?>
										<table>
										<tr>
											<td width="160px"><?php esc_html_e( 'If User selected plan is', 'armember-membership' ); ?></td>
											<td>
													<input type='hidden' id='arm_conditional_redirect_setup_change_plan_0' name="arm_redirection_settings[setup_change][conditional_redirect][0][plan_id]" value="<?php echo intval($setup_change_plan_id); ?>" />
													<dl class="arm_selectbox column_level_dd">
														...
														<dd>
															<ul data-id="arm_conditional_redirect_setup_change_plan_0">
																<li data-label="<?php esc_attr_e( 'Select Plan', 'armember-membership' ); ?>" data-value="0"><?php esc_html_e( 'Select Plan', 'armember-membership' ); ?></li>
																<li data-label="<?php esc_attr_e( 'Any Plan', 'armember-membership' ); ?>" data-value="-3"><?php esc_html_e( 'Any Plan', 'armember-membership' ); ?></li>
																<?php
																if ( ! empty( $all_plans ) ) {
													...
													<span class="arm_rsc_error arm_conditional_redirect_setup_change_plan_require_0">
														<?php esc_html_e( 'Please select plan.', 'armember-membership' ); ?>
													</span> 
											</td>
										...
										<tr>
											...
											<td colspan="3" width="540px">
												...
												$arm_global_settings->arm_wp_dropdown_pages(
													array(
														'selected' => 0,
														'name' => 'arm_redirection_settings[setup_change][conditional_redirect][0][url]',
														'id' => 'arm_setup_change_conditional_redirection_url_0',
														'show_option_none' => esc_html__( 'Select Page', 'armember-membership' ),
														'option_none_value' => 0,
														'class' => 'arm_member_form_input arm_setup_change_conditional_redirection_url',
														'required' => true,
														'required_msg' => esc_html__( 'Please select redirection page.', 'armember-membership' ),
													)
												);
												?>
												<span class="arm_rsc_error arm_setup_change_conditional_redirection_url_require_0">
													<?php esc_html_e( 'Please select a page.', 'armember-membership' ); ?>
												</span>  
											</td>
										</tr>
										...
										foreach ( $arm_redirection_setup_change_conditional_redirect as $arm_setup_change_conditional ) {
											if ( is_array( $arm_setup_change_conditional ) ) {
												...
												?>
									<li id="arm_setup_change_conditional_redirection_box<?php echo intval($ckey); ?>" class="arm_setup_change_conditional_redirection_box_div">
					...
					<table class="form-table">
						<tr>
							...
							<td class="arm-form-table-content">                     
								...
								<?php if($ARMemberLite->is_arm_pro_active){?>
									<label class="arm_min_width_100">
                                        <input type="radio" name="arm_redirection_settings[setup_renew][type]" value="conditional_redirect" class="arm_redirection_settings_setup_renew_radio arm_iradio" <?php checked($arm_redirection_setup_renew_type, 'conditional_redirect');?> >
                                       <span><?php esc_html_e('Conditional Redirect','armember-membership');?></span>
                                	</label>
								<?php }?>
						...
						<tr  id="arm_redirection_settings_setup_renew_conditional_redirect" class="arm_redirection_settings_setup_renew 
						<?php
						...
						">
							...
							<td>  
								<div class="arm_setup_renew_conditional_redirection_main_div">
									<ul class="arm_setup_renew_conditional_redirection_ul arm_margin_bottom_20" >
									<?php
									if ( empty( $arm_redirection_setup_renew_conditional_redirect ) ) {
										...
										$url = ARMLITE_HOME_URL;
										?>
									<li id="arm_setup_renew_conditional_redirection_box0" class="arm_setup_renew_conditional_redirection_box_div">
								  
										<a class="arm_remove_setup_renew_redirection_condition" href="javascript:void(0)" data-index="0"><img src='<?php echo esc_attr(MEMBERSHIPLITE_IMAGES_URL); ?>/arm_close_icon.png' onmouseover="this.src='<?php echo esc_attr(MEMBERSHIPLITE_IMAGES_URL); ?>/arm_close_icon_hover.png';" onmouseout="this.src='<?php echo esc_attr(MEMBERSHIPLITE_IMAGES_URL); ?>/arm_close_icon.png';" /></a> <?php //phpcs:ignore ?>
										<table>
										<tr>
											<td width="160px"><?php esc_html_e( 'If User selected plan is', 'armember-membership' ); ?></td>
											<td>
													<input type='hidden' id='arm_conditional_redirect_setup_renew_plan_0' name="arm_redirection_settings[setup_renew][conditional_redirect][0][plan_id]" value="<?php echo intval($setup_renew_plan_id); ?>" />
													<dl class="arm_selectbox column_level_dd">
										...
										foreach ( $arm_redirection_setup_renew_conditional_redirect as $arm_setup_renew_conditional ) {
											if ( is_array( $arm_setup_renew_conditional ) ) {
												...
												?>
									<li id="arm_setup_renew_conditional_redirection_box<?php echo intval($ckey); ?>" class="arm_setup_renew_conditional_redirection_box_div">
...
<div id="arm_all_plans" style="display:none;visibility: hidden;opacity: 0;"><?php echo json_encode( $all_plans ); ?></div>
<div id="arm_all_signup_forms" style="display:none;visibility: hidden;opacity: 0;"><?php echo json_encode( $arm_forms ); ?></div>
<div id="arm_all_edit_profile_forms" style="display:none;visibility: hidden;opacity: 0;"><?php echo json_encode($arm_edit_profile_forms); ?></div>
<script>
